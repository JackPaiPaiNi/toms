...
<head>
	...
	<script src="<%=basePath%>js/platform/modelmap/modelMap.js" ></script>
...
<body>
	...
	<div id="modelmaptb" style="padding:2px 5px;">
	    <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="showAddWin();" tcl-text="toolbar.add"></a>
	   	<a href="<%=basePath%>download/ModelmapInfo.xls" class="easyui-linkbutton" iconCls="icon-arrow-down" plain="true" tcl-text="toolbar.downtemplate"></a>
	            ...
	            <form id="addModelmapForm" method="post" enctype="multipart/form-data">
	            	...
	            	<table style="width: 100%;">
	            		<tr>
		            		...
		            		<td><input type="text" id="branchModel" class="easyui-textbox easyui-validatebox"  data-options="required:true" name="branchModel"/></td>
		            		<td><i class="required">*</i><span tcl-text="modelmap.list.th.hqModel"></span>:</td>
		            		<td><input type="text" style="width:154px" id="hqModel"  name="hqModel" data-options="required:true"/></td>
	            		</tr>
	            		<tr>
		            		...
		            		<td><input type="text" style="width:154px" name="partyId" editable="false" data-options="required:true,editable:false"/></td>
	            		</tr>
	            	</table>
	            </form>
	        </div>
