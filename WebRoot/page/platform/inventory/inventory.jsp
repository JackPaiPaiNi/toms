...
<head>
	<meta charset="utf-8">
	<title><s:text name='permission.labelkey.kcgl'/></title>
	<script src="<%=basePath%>js/platform/inventory/inventory.js" ></script>
	...
	<div id="stargettb" style="padding:2px 5px;">
	    ...
	    <div style="margin-bottom:5px">
			<!-- <a href="#" class="easyui-linkbutton" iconCls="icon-redo" plain="true" onclick="exportExcel();" tcl-text="toolbar.export"></a> -->
			 <a href="#" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="importInventory();" ><!-- tcl-text="toolbar.import"> --></a> 
			 <a href="<%=basePath%>download/inventoryInfoEN.xlsx" class="easyui-linkbutton" iconCls="icon-arrow-down" plain="true" tcl-text="toolbar.downtemplate"></a>
			 <a class="tcl-gridbar-separator"></a>
		</div>
		<div>
			<%-- <span tcl-text="inventory.list.search.date"></span>
			<input type="text" style="width:100px" class="easyui-datebox" name="searchDate" id="searchDate"/> --%>
			<span tcl-text="inventory.list.search.party"></span>
			<input class="easyui-textbox" id="searchPatry" style="width:100px">
			<%-- <span tcl-text="inventory.list.search.customer"></span>
			<input class="easyui-textbox" id="searchCustomer" style="width:100px"> --%>
			<span tcl-text="inventory.list.search.shop"></span>
			<input class="easyui-textbox" id="searchShop" style="width:100px">
			<span tcl-text="inventory.list.search.hqMadel"></span>
			<input class="easyui-textbox" id="searchHqModel" style="width:100px">
			<span tcl-text="inventory.list.search.model"></span>
