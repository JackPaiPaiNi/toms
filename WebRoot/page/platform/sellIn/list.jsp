...
<head>
	<meta charset="utf-8">
	<title><s:text name='permission.labelkey.return'/></title>
	<script>var my_login_id='<%=party%>';</script>
	<script src="<%=basePath%>js/platform/sellIn/list.js" ></script>
...
<body>
	<table id="returnListTable" name="gridTable"></table>
	<div id="shoptb" style="padding:2px 5px;">
		<div style="margin-bottom:5px">
	    	<a href="#" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="importSellIn();"  ><!-- tcl-text="toolbar.import"> --> </a> 
	    	<a href="<%=basePath%>download/Sell-In.xlsx" class="easyui-linkbutton" iconCls="icon-arrow-down" plain="true" tcl-text="toolbar.downtemplate"></a>
	    	<a class="tcl-gridbar-separator"></a>
    	</div>
    	<div>
    	
    	<span tcl-text="district.countryName"></span>:
	    	<select class="easyui-combobox" id="tcl_country" panelHeight="auto" style="width:100px"  data-options="editable:false">
		    </select>
	            ...
	            <form id="addShopForm" method="post" enctype="multipart/form-data">
	            	...
	            	<table style="width: 100%;">
	            		...
	            		<tr>
		            		...
		            		<td><input type="text" id="provinceId" style="width:154px" name="provinceId" editable="false" data-options="required:true,editable:false"/></td>
	            		</tr>
	            		<tr>
	            		...
	            		<tr>
		            		...
		            		<td><input type="text" name="detailAddress" class="easyui-textbox" data-options="required:true"/></td>
		            		<td><i class="required">*</i><span tcl-text="shop.list.th.lng"></span>:</td>
		            		<td><input type="text" name="lng" class="easyui-textbox" data-options="required:true"/></td>
		            		<td><i class="required">*</i><span tcl-text="shop.list.th.lat"></span>:</td>
		            		<td><input type="text" name="lat" class="easyui-textbox" data-options="required:true"/></td>
	            		</tr>
	            		<tr>
	            		...
	            		<tr>
	            			...
	            			<td><input type="text" id="level"  style="width:154px" name="level" editable="false" data-options="required:true,editable:false,panelHeight:'auto'"/></td>
	            		</tr>
	            	</table>
