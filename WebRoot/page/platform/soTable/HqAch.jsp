...
<head>
    ...
    <script src="<%=basePath%>js/platform/soTable/hqAch.js" type="text/javascript" charset="utf-8"></script>
	<script src="<%=basePath%>js/platform/soTable/loadDataByHq.js" type="text/javascript" charset="utf-8"></script>
			...
			<div id="tabs-2">
				...
				<div class="fl concreteness" id="tabs_2_3">
					<div class="selctPadTop">
						<fieldset class="inb">
							<label for="">Half</label>
							<input readonly  style="width:130px;display:inline-block;height:22px;padding:0;"  id="HalfXCP"  readonly name="reservatio" type="text" onfocus="WdatePicker({dateFmt:'yyyy',isShowClear:true});" class="day-Custom form-control"/>
							...
							<button  onclick="getHalfXCP()" style="">Search</button>
