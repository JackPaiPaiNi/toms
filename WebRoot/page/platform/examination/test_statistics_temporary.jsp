...
<html>
  <head>   
    ...
    <script type="text/javascript" src="<%=basePath%>js/platform/examination/grade.js"></script>    
        	...
        	<div class="Query-Condition">
        		...
        		<select id="column" name="column">
	        		...
	        		<select id="subtocolumn" name="subtocolumn">
        			 ...
        			 Start:<input class="startdate" readonly type="text" onFocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM-dd HH:mm:ss'})">To:<input class="enddate" readonly type="text" onFocus="WdatePicker({lang:'en',dateFmt:'yyyy-MM-dd HH:mm:ss'})">  
        		<!-- 业务区域,国家 -->
        		<%if(countryId.equals("999")){ %>
