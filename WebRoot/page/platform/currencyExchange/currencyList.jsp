...
<head>
	...
	<script src="<%=basePath%>js/platform/currencyExchange/currencyList.js" ></script>
	            ...
	            <form id="addCurrecncyForm" method="post" enctype="multipart/form-data" style="height:80px;">
	            	...
	            	<table style="width: 100%;">
	            		<tr>
				                ...
				                <td><input type="text" class="easyui-textbox" id="countryId" class="easyui-textbox easyui-validatebox" name="countryId" data-options="required:true"></input></td>
			            ...
			            <tr>
					            ...
					            <td><input type="text" class="easyui-datebox"  name="datadate" data-options="required:true"></input></td>			       
				         </tr>  
	            	</table>
	            </form>
	        </div>
