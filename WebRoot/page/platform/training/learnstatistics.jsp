...
<html>
  <head>   
    <title><s:text name='permission.labelkey.learn'></s:text></title>
    <script type="text/javascript" src="<%=basePath%>js/platform/training/learnstatistics.js"></script>    
		...
		<div class="main">        	
        	...
        	<div class="Query-Condition">
        		...
        		<%if(countryId.equals("999")){ %>
	     		...
	     		<a href="#" class="easyui-linkbutton" iconCls="icon-arrow-down" plain="true" onclick="exportExcel();"   tcl-text="toolbar.downLearnList" ></a> 
	     		</div>
	     		...
	     		<a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-search" id="searchBt" onclick="doSearch();" tcl-text="toolbar.search"></a>
	     		<div class="tcl-gridbar-separator"></div>
	     		<a href="#" class="easyui-linkbutton" iconCls="icon-arrow-down" plain="true" onclick="exportRusExcel();"   tcl-text="toolbar.downLearnList" ></a> 
	     		<%}else{%>
	     			<div class="regioncountry" style="display:none;">&nbsp;&nbsp;&nbsp;&nbsp;Region-Country
	     			<select id="region" name="region">
	     				<option value="0">Please Select The Business Center</option>	
