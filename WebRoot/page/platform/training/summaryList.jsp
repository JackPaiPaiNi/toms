...
<html>
  <head>
    ...
    <title><s:text name="permission.labelkey.slist"></s:text></title>
	...
	<script type="text/javascript" src="<%=basePath%>js/platform/training/summaryList.js"></script>
	            ...
	            <form id="addCourseForm" method="post" enctype="multipart/form-data"  accept="image/gif,image/jpeg,image/jpg,image/png,/image/bmp">
	            	...
	            	<table style="width: 100%;">
	            		...
	            		<tr>
			           	...
			           	<tr>
					           <td ><i class="required">*</i><span style="color:red"></span><s:text name="summary.Column" />:</td>
				               <td><select   id="typeId" name="typeId" style="width:174px;height: 23px">
				               	   </select>
				               </td>					         			           					           				         			           		   
			           	</tr>
	            		<tr>
					           <td ><i class="required">*</i><span style="color:red"></span><s:text name="summary.messageType" />:</td>
				               <!-- <td><input type="text"  id="messageType" name="messageType" data-options="required:true,editable:false,panelHeight:'auto'"></input></td>	 -->				         
			           		   <td><select id="summaryType" name="summaryType" style="width:174px;height: 23px">
					           		   		<option value="1"><s:text name="train.summary.image"></s:text></option>
						     				<option value="2"><s:text name="train.summary.articl"></s:text></option>
						     				<option value="3"><s:text name="train.summary.video"></s:text></option> 		
			           		   		</select>
			           		   </td>
			           		   <td ><s:text name="summary.coverImgUrl" />:</td>
			           		   <td><input  id="file" type="file" onchange="check()"  name="fileUploadTools.uploadFile" / style="display: inline-block;width:200px;"><input type="hidden" id="hidcover" name="coverUrl"/><input id="coverupload" type="button" value="upload" onclick="upload()"><%-- <i style="display:inline-block;width:20px;height: 20px; background:url(<%=basePath%>/images/training/upload2.png) no-repeat center center;background-size: 12px 18px;cursor: pointer;"></i> --%></td>
			           	</tr>
			           	
			           	 <tr>
					          	
				         		<td ><i class="required">*</i><span style="color:red"></span><s:text name="summary.regionId" />:</td>
				                ...
				                <td><select   id="regionId"  	name="regionId" style="width:174px">
				                	</select>
				                </td>
				                <td ><!-- <i class="required">*</i> --><s:text name="summary.country" />:</td>
				                ...
				                <td><select   id="countryId"  	name="countryId" style="width:174px">
				                	</select>
				              </td>
				         </tr>  
	            	 ...
	            	 <%-- 	<tr>
	            	 	...
	            	 	<tr id="role1">
							...
							<td ><s:text name="summary.state" />: </td>
					 	...
					 	<tr id="role2">
			           	...
			           	<tr>
					           <td ><i class="required">*</i><span style="color:red"></span><s:text name="summary.Title" />:</td>
				               <!-- <td colspan="2"><input  class="easyui-textbox" id="summaryTitle" style="width:383px;height:40px;" class="easyui-textbox easyui-validatebox" name="summaryTitle" data-options="multiline:true"></input></td> -->			         			           		   
			           			<td colspan="2"><textarea   id="summaryTitle" style="width:383px;height:40px;resize: none;"  name="summaryTitle" ></textarea></td>
			           	</tr>
			           	
			           	<tr>
			           			 <td ><i class="required">*</i><span style="color:red"></span><s:text name="summary.Summary" />: </td>
			           			<!-- <td colspan="2"><input   class="easyui-textbox" id="summary" style="width:383px;height:40px;" name="summary" data-options="multiline:true"></input></td> -->
			           			<td colspan="2"><textarea rows="" cols=""  id="summary" style="width:383px;height:40px;resize: none;" name="summary" ></textarea></td>
			           	</tr>					         
			           		
			           	
					   <tr>		
					         	<td ><i class="required">*</i><span style="color:red"></span><s:text name="summary.Content" />:</td>					           
					            <td colspan="3"><textarea id="editor" id="courseContent" name="courseContent"	style="width:700px;height:250px;"></textarea></td>
					    </tr>
