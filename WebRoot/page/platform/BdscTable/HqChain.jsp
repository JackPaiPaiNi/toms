...
<head>
	...
	<script src="<%=basePath%>js/platform/BdscTable/HqChain.js" type="text/javascript" charset="utf-8"></script>
	<script src="<%=basePath%>js/platform/BdscTable/loadDataByHqChain.js" type="text/javascript" charset="utf-8"></script>
