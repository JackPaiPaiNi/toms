       ...
       <div class="main">
        	<!--内容标题-->
         	...
         	<div class="content_body">
         		<!--门店目标-->
	     		<div class="easyui-tabs" id="addTabsMineAc">
	     			<div title="Month" style="padding:10px">
	     				...
	     				<div style="margin-bottom:6px;">
	     					<span class="monthTitle">Month</span>
	         		 		<input  id="date"  onchange="selectBDSCTarget('2')" readonly name="reservatio" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM'})" />
	     				</div>
	     				<!--表格-->
	     			...
	     			<div title="Year" style="padding:10px" onclick="selectBDSCTargetYear('2')">
		     			<p class="StoresTarget" id="StoresTarget">
			     		...
			     		<div style="margin-bottom:6px;" onresize="parent.location.reload();">
	     					<span class="monthTitle">Year</span>
	         		 		<input  id="dateYear"  onchange="selectBDSCTargetYear('2')" readonly name="reservatio" type="text" onclick="WdatePicker({dateFmt:'yyyy'})" />
	     				</div>
				     			...
				     			<table border="0" cellspacing="0" cellpadding="0">
				         			<thead>
				         				<tr style="border-top: 1px solid #bbb;">
				         					...
				         					<th rowspan="2">Type</th>
				         					<th style="border-right:2px solid #bbb;">Total Target</th>
				         					<th style="border-right:2px solid #bbb;">UD Target</th>
					         			</tr>
				         			</thead>
				         			<tbody id="" >
