...
<head>
	<meta charset="utf-8">
	<title><s:text name='permission.labelkey.zdsctp'/></title>
	<script src="<%=basePath%>js/platform/sale/photolist.js" ></script>
...
<body>
	...
	<div id="stargettb" style="padding:2px 5px;">
		...
		<span tcl-text="photo.list.search.party"></span>
		<input class="easyui-textbox" id="searchParty" style="width:110px">
		<span tcl-text="photo.list.search.customer"></span>
