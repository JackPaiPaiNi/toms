...
<head>
	<meta charset="utf-8">
	<title><s:text name='permission.labelkey.xssjgl'/></title>
	<script src="<%=basePath%>js/platform/sale/list_mobile.js" ></script>
...
<body>
	...
	<div id="saletb" style="padding:2px 5px;">
	   ...
	   <%--   <a href="#" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="importSales();" tcl-text="toolbar.import"></a>
		...
		<span tcl-text="sale.list.search.party"></span>
		<input class="easyui-textbox" id="searchParty" style="width:100px">
		<span tcl-text="sale.list.search.cparty"></span>
		<input class="easyui-textbox" id="searchCParty" style="width:100px">
		<span tcl-text="sale.list.search.customer"></span>
		<input class="easyui-textbox" id="searchCustomer" style="width:100px">
		<span tcl-text="sale.list.search.shop"></span>
