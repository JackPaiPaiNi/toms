...
<head>
	<meta charset="utf-8">
	<title><s:text name='permission.labelkey.acbb'/></title>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>css/baobiaozidingyi.css"/>
	 ...
	 <script type="text/javascript" src="<%=basePath%>js/platform/statement/acstatement.js" ></script>
	  <script type="text/javascript" src="<%=basePath%>js/platform/statement/excelByAc.js" ></script>
...
<!--             			<option value='jeffreynadera'>Test</option>      -->
         	...
         	<div class="KeyUpload-DownloadTemplates"  >
        		 <span class="DownloadTemplates "  tcl-text="statement.dtf"><!--下载模板--></span>
         		 <a id="flip" href="#" class="downloadtemplates" ></a>
         		  <p id="upTe" class="inb" style="display: inline-block;"></p>
	...
	%>
		<li><a href="<%=basePath%>download/TV SO data upload.xlsx"  plain="true"  >Template</a></li>
...
<!--          		<a class="" href="#"></a>	         		       		 -->
     		...
     		<div class="Coreproduct-Chart">         			
       		...
       		<div class="salestrends salestrends22222">
...
<!--      					<a class="fr" href="#"></a>     					 -->
			...
			<span tcl-text="statement.personnelEfficiency"></span><!--人员效率--><!-- Personnel Efficiency -->
				<select id="per_eff_date">
     			...
     			<select id='acMachineType'></select>
