...
function loadYearHtmlRightBottomJoint(dataArr,selectObj){
	...
	for(var i = 0;i < dataArr.length; i++){
		if(center == dataArr[i].center){
			...
			o.last_year_Q1 += toRound(isNullReturnZero(dataArr[i].last_year_Q1));
			o.this_year_Q1 += toRound(isNullReturnZero(dataArr[i].this_year_Q1));
			
			o.last_year_Q2 += toRound(isNullReturnZero(dataArr[i].last_year_Q2));
			o.this_year_Q2 += toRound(isNullReturnZero(dataArr[i].this_year_Q2));
			
			o.last_year_Q3 += toRound(isNullReturnZero(dataArr[i].last_year_Q3));
			o.this_year_Q3 += toRound(isNullReturnZero(dataArr[i].this_year_Q3));
			
			o.last_year_Q4 += toRound(isNullReturnZero(dataArr[i].last_year_Q4));
			o.this_year_Q4 += toRound(isNullReturnZero(dataArr[i].this_year_Q4));
			
			if(dataArr.length - i == 1){
				o.year_growth = getGrowthRate(o.last_year_qty,o.this_year_qty);
				o.Q1_growth = getGrowthRate(o.last_year_Q1,o.this_year_Q1);
				o.Q2_growth = getGrowthRate(o.last_year_Q2,o.this_year_Q2);
				o.Q3_growth = getGrowthRate(o.last_year_Q3,o.this_year_Q3);
				o.Q4_growth = getGrowthRate(o.last_year_Q4,o.this_year_Q4);
...
function jointStrYear(o){
	return "<tr>" +
				...
				"<th style='text-align: right;'>"+ toThous(isNullReturnZero(o.last_year_Q1)) +"</th>" +
				"<th style='text-align: right;'>"+ toThous(isNullReturnZero(o.this_year_Q1)) +"</th>" +
				growthRate(o.Q1_growth) +
				"<th style='text-align: right;'>"+ toThous(isNullReturnZero(o.last_year_Q2)) +"</th>" +
				"<th style='text-align: right;'>"+ toThous(isNullReturnZero(o.this_year_Q2)) +"</th>" +
				growthRate(o.Q2_growth) +
				"<th style='text-align: right;'>"+ toThous(isNullReturnZero(o.last_year_Q3)) +"</th>" +
				"<th style='text-align: right;'>"+ toThous(isNullReturnZero(o.this_year_Q3)) +"</th>" +
				growthRate(o.Q3_growth) +
				"<th style='text-align: right;'>"+ toThous(isNullReturnZero(o.last_year_Q4)) +"</th>" +
				"<th style='text-align: right;'>"+ toThous(isNullReturnZero(o.this_year_Q4)) +"</th>" +
				growthRate(o.Q4_growth) +
			"</tr>";
};
...
function jointStrTDYear(o,selectObj){
	...
	return "<tr>" +
				...
				growthRate(o.year_growth) +
				"<td style='text-align: right;'>"+ toThous(isNullReturnZero(o.last_year_Q1)) +"</td>" +
				"<td style='text-align: right;'>"+ toThous(isNullReturnZero(o.this_year_Q1)) +"</td>" +
				growthRate(o.Q1_growth) +
				"<td style='text-align: right;'>"+ toThous(isNullReturnZero(o.last_year_Q2)) +"</td>" +
				"<td style='text-align: right;'>"+ toThous(isNullReturnZero(o.this_year_Q2)) +"</td>" +
				growthRate(o.Q2_growth) +
				
				"<td style='text-align: right;'>"+ toThous(isNullReturnZero(o.last_year_Q3)) +"</td>" +
				"<td style='text-align: right;'>"+ toThous(isNullReturnZero(o.this_year_Q3)) +"</td>" +
				growthRate(o.Q3_growth) +
				
				"<td style='text-align: right;'>"+ toThous(isNullReturnZero(o.last_year_Q4)) +"</td>" +
				"<td style='text-align: right;'>"+ toThous(isNullReturnZero(o.this_year_Q4)) +"</td>" +
				growthRate(o.Q4_growth) +
			"</tr>";
};
...
function loadYearHtmlRightHeadJoint(selectObj){
	return "<table>" +
				"<thead>" +
					"<tr>" +
						"<th colspan='3'>"+ ((selectObj.selectDateVal) - 1) +" VS "+  selectObj.selectDateVal+"  Sell-Out</th>" +
						"<th colspan='3'>"+  ((selectObj.selectDateVal) - 1) +" Q1 VS "+selectObj.selectDateVal +" Q1 Sell-Out</th>" +
						"<th colspan='3'>"+ ((selectObj.selectDateVal) - 1)+" Q2 VS "+ selectObj.selectDateVal  +" Q2 Sell-Out</th>" +
						"<th colspan='3'>"+ ((selectObj.selectDateVal) - 1) +" Q3 VS "+ selectObj.selectDateVal +" Q3 Sell-Out</th>" +
						"<th colspan='3'>"+ ((selectObj.selectDateVal) - 1) +" Q4 VS "+ selectObj.selectDateVal +" Q4 Sell-Out</th>" +
					...
					"<tr>" +
						...
						"<th>Growth Rate%</th>" +
						"<th>"+ ((selectObj.selectDateVal) - 1) +" Q1 Achieved</th>" +
						"<th>"+ selectObj.selectDateVal +" Q1 Achieved</th>" +
						"<th>Growth Rate%</th>" +
						"<th>"+ ((selectObj.selectDateVal) - 1) +" Q2 Achieved</th>" +
						"<th>"+ selectObj.selectDateVal +" Q2 Achieved</th>" +
						"<th>Growth Rate%</th>" +
						
						"<th>"+ ((selectObj.selectDateVal) - 1) +" Q3 Achieved</th>" +
						"<th>"+ selectObj.selectDateVal +" Q3 Achieved</th>" +
						"<th>Growth Rate%</th>" +
						
						"<th>"+ ((selectObj.selectDateVal) - 1) +" Q4 Achieved</th>" +
						"<th>"+ selectObj.selectDateVal +" Q4 Achieved</th>" +
						"<th>Growth Rate%</th>" +
					"</tr>" +
				"</thead>" +
				"<tbody>";
...
function loadQuarterHtmlRightHeadJoint(selectObj){
	...
	"<thead>" +
	"<tr>" +
	"<th colspan='3'>"+  ((selectObj.selectDateVal) - 1) +" "+ selectObj.selectHAY +" VS "+selectObj.selectDateVal +" "+ selectObj.selectHAY +"  Sell-Out</th>" +
	"<th colspan='3'>"+((selectObj.selectDateVal) - 1) +" " +oy+ " VS "+  selectObj.selectDateVal +" " +oy+ " Sell-Out</th>" +
	"<th colspan='3'>"+((selectObj.selectDateVal) - 1)+" " +twy+ " VS "+  selectObj.selectDateVal  +" " +twy+ " Sell-Out</th>" +
	"<th colspan='3'>"+ ((selectObj.selectDateVal) - 1) +" " +thy+ " VS "+ selectObj.selectDateVal +" " +thy+ " Sell-Out</th>" +
	"</tr>" +
	"<tr>" +
...
function loadYearHtmlLeftHeadJoint(selectObj){
	return "<table>" +
				"<thead>" +
					"<tr>" +
						"<th rowspan='2'>"+  ((selectObj.selectDateVal) - 1) +" VS "+selectObj.selectDateVal +" Sell-Out</th>" +
					"</tr>" +
				"</thead>" +
				"<tbody>";
};
...
function loadHalfAYearHtmlLeftHeadJoint(selectObj){
	return "<table>" +
				"<thead>" +
					"<tr>" +
						"<th rowspan='2'>"+((selectObj.selectDateVal) - 1) +" "+ selectObj.selectHAY +" VS "+  selectObj.selectDateVal +" "+ selectObj.selectHAY +" Sell-Out</th>" +
					"</tr>" +
				"</thead>" +
			"<tbody>";
};
