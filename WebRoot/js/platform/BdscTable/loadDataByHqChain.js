...
function loadYearTotalHead(obj,beginDate,endDate,what,head){//加载表头
	...
	html+='	<th colspan="2">'+beg[0]+' Q1 '+head+' Sell-Out </th>';
	html+='	<th colspan="2">'+beg[0]+' Q2 '+head+' Sell-Out </th>';
	html+='	<th colspan="2">'+beg[0]+' Q3 '+head+' Sell-Out </th>';
	html+='	<th colspan="2">'+beg[0]+' Q4 '+head+' Sell-Out </th>';
	html+='</tr>';
	html+='<tr>';
	html+='<th>Achieved</th>';	
	...
	for ( var i = 0; i < by.length; i++) {
		if(center!=null && center!="" && center==by[i].center){
			...
			if(beg[0]==tYear &&   tMonth>=1 && tMonth<=3 ){
				counHtml+='<td style="background-color: yellow;color:#000;text-align:right";>'+isStringNullAvaliableNum(by[i].saleQtyQ1)+'</td>';
			}else{
				counHtml+='<td style="text-align:right";>'+isStringNullAvaliableNum(by[i].saleQtyQ1)+'</td>';
			}
			...
			if(beg[0]==tYear &&  tMonth>=4 && tMonth<=6){
				counHtml+='<td style="background-color: yellow;color:#000;text-align:right";>'+isStringNullAvaliableNum(by[i].saleQtyQ2)+'</td>';
			}else{
				counHtml+='<td style="text-align:right";>'+isStringNullAvaliableNum(by[i].saleQtyQ2)+'</td>';
			}
			...
			if(beg[0]==tYear &&  tMonth>=7 && tMonth<=9){
				counHtml+='<td style="background-color: yellow;color:#000;text-align:right";>'+isStringNullAvaliableNum(by[i].saleQtyQ3)+'</td>';
			}else{
				counHtml+='<td style="text-align:right";>'+isStringNullAvaliableNum(by[i].saleQtyQ3)+'</td>';
			}
			...
			if(beg[0]==tYear &&  tMonth>=10 && tMonth<=12){
				counHtml+='<td style="background-color: yellow;color:#000;text-align:right";>'+isStringNullAvaliableNum(by[i].saleQtyQ4)+'</td>';
			}else{
				counHtml+='<td style="text-align:right";>'+isStringNullAvaliableNum(by[i].saleQtyQ4)+'</td>';
			}
			
			counHtml+=growthRateHQ(by[i].gro4);
			...
			if(by.length- i == 1){
				...
				html+='<th style="text-align:right";>'+isStringNullAvaliableNum(saleQtyQ1)+'</th>';
				html+='<th style="text-align:right";> </th>';
				
				html+='<th style="text-align:right";>'+isStringNullAvaliableNum(saleQtyQ2)+'</th>';
				if(saleQtyQ2==0){
					...
					var gro=(saleQtyQ2-saleQtyQ1)/saleQtyQ1;
					html+=growthRateHQ(Math.round(gro*100)+'%');

				}
				
				
				html+='<th style="text-align:right";>'+isStringNullAvaliableNum(saleQtyQ3)+'</th>';
				if(saleQtyQ3==0){
					html+=growthRateHQ('-100%');
					...
					var gro=(saleQtyQ3-saleQtyQ2)/saleQtyQ2;
					html+=growthRateHQ(Math.round(gro*100)+'%');

				}
				
				html+='<th style="text-align:right";>'+isStringNullAvaliableNum(saleQtyQ4)+'</th>';
				if(saleQtyQ4==0){
					html+=growthRateHQ('-100%');
					...
					var gro=(saleQtyQ4-saleQtyQ3)/saleQtyQ3;
					html+=growthRateHQ(Math.round(gro*100)+'%');
				...
				html+='<th style="text-align:right";>'+isStringNullAvaliableNum(saleQtyQ1OBC)+'</th>';
				html+='<th style="text-align:right";> </th>';
				
				html+='<th style="text-align:right";>'+isStringNullAvaliableNum(saleQtyQ2OBC)+'</th>';
				if(saleQtyQ2OBC==0){
					html+=growthRateHQ('-100%');

				}else if(saleQtyQ1OBC==0){
					html+=growthRateHQ('100%');

				}else{
					var gro=(saleQtyQ2OBC-saleQtyQ1OBC)/saleQtyQ1OBC;
					html+=growthRateHQ(Math.round(gro*100)+'%');

				}
				
				
				html+='<th style="text-align:right";>'+isStringNullAvaliableNum(saleQtyQ3OBC)+'</th>';
				if(saleQtyQ3OBC==0){
					html+=growthRateHQ('-100%');

				}else if(saleQtyQ2OBC==0){
					html+=growthRateHQ('100%');

				}else{
					var gro=(saleQtyQ3OBC-saleQtyQ2OBC)/saleQtyQ2OBC;
					html+=growthRateHQ(Math.round(gro*100)+'%');

				}
				
				
				html+='<th style="text-align:right";>'+isStringNullAvaliableNum(saleQtyQ4OBC)+'</th>';
				if(saleQtyQ4OBC==0){
					html+=growthRateHQ('-100%');

				}else if(saleQtyQ3OBC==0){
					html+=growthRateHQ('100%');

				}else{
					var gro=(saleQtyQ4OBC-saleQtyQ3OBC)/saleQtyQ3OBC;
					html+=growthRateHQ(Math.round(gro*100)+'%');
	...
	function loadQuarterTotalData(obj,beginDate,endDate,what,head){//加载数据
		...
		for ( var i = 0; i < by.length; i++) {
			if(center!=null && center!="" && center==by[i].center){
				...
				if(beg[0]==tYear && (tMonth==1 || tMonth==4 || tMonth==7 || tMonth==10) && isQ){
				...
				if(beg[0]==tYear && (tMonth==2 || tMonth==5 || tMonth==8 || tMonth==11) &&isQ){
				...
				if(beg[0]==tYear && (tMonth==3 || tMonth==6 || tMonth==9 || tMonth==12) && isQ){
