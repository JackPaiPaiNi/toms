...
$(function(){
	$("#returnListTable").datagrid({
		title:locale("sellIn.title"),
		url:baseUrl + 'platform/selectSellInByTable.action',
		pagination:true,
		rownumbers:true,
		singleSelect:true,
		nowrap:false,
	    ...
	    columns:[[
	        ...
	        {field:'orderNum',title:locale("sellIn.orderNum"),width:100}
	    ]],
	    toolbar:'#shoptb',
...
//导入数据
function importSellIn(){
	showImportWin(locale("import.sellIn"),baseUrl + "platform/importSellIn.action");
}
