...
function YearTotal(beginDate,endDate,what){
	...
	if(what=="Total"){
		...
		$("#YearXCPText").text(begMonth[0]+"  "+head+"  Sell-Out");
		
	}else if(what=="Smart"){
		o.what="yearSmartByHQ";
		o.check=$("#YearSmartCheck").is(':checked');
		$("#YearSmartText").text(begMonth[0]+" Smart  Sell-Out");
	}else if(what=="Big"){
		o.what="yearBigByHQ";
		...
		$("#YearBigText").text(begMonth[0]+" Big Sell-Out");
	}else if(what=="Curved"){
		o.what="yearCurvedByHQ";
		o.check=$("#YearCurvedCheck").is(':checked');

		$("#yearCurvedText").text(begMonth[0]+" Curved Sell-Out");
	}
