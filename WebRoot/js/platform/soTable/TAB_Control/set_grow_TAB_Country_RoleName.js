...
function loadMonthMenuEN(obj,language){
	if('en' == language){
		$('#month_region_head').html(obj.en_region_head);
		$('#month_sale').html(obj.en_sale);
		$('#mongth_acfo').html(obj.en_ACFO);
		$('#mongth_county').html(obj.en_country);
	}else if('zh' == language){
		$('#month_region_head').html(obj.zh_region_head);
		$('#month_sale').html(obj.zh_sale);
		$('#mongth_acfo').html(obj.zh_ACFO);
		$('#mongth_county').html(obj.zh_country);
	}else{
		$('#month_region_head').html(obj.ftzw_region_head);
		$('#month_sale').html(obj.ftzw_sale);
		$('#mongth_acfo').html(obj.ftzw_ACFO);
		$('#mongth_county').html(obj.ftzw_country);
	}
};
...
function loadWeekMenuEN(obj,language){
	if('en' == language){
		$('#week_regio_head').html(obj.en_region_head);
		$('#week_sale').html(obj.en_sale);
		$('#week_acfo').html(obj.en_ACFO);
	}else if('zh' == language){
		$('#week_regio_head').html(obj.zh_region_head);
		$('#week_sale').html(obj.zh_sale);
		$('#week_acfo').html(obj.zh_ACFO);
	}else{
		$('#week_regio_head').html(obj.ftzw_region_head);
