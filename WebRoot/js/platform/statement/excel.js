					...
					success:function(data){
					        if(data.success=="true")
				        	{
								...
								/*	if(level!=""  && level!=null ){
									...
									var url ;
									if(soType=="shop"){
						        		url =   baseUrl+ "platform/exportDaily.action?date="+date+str+"";

									}else if(soType=="customer"){
						        		url =  baseUrl+ "platform/exportDailyCustomer.action?date="+date+str+"";
									...
									if(soType=="shop"){
						        		url =baseUrl + "platform/exportWeekly.action?beginDate="+beginDate+"&endDate="+endDate+str+"";

									}else if(soType=="customer"){
						        		url =  baseUrl + "platform/exportWeeklyCustomer.action?beginDate="+beginDate+"&endDate="+endDate+str+"";
									...
									if(soType=="shop"){
						        		url =baseUrl + "platform/exportMonthly.action?beginDate="+beginDate+"&endDate="+endDate+str+"";

									}else if(soType=="customer"){
						        		url =baseUrl + "platform/exportMonthlyCustomer.action?beginDate="+beginDate+"&endDate="+endDate+str+"";

									}else if(soType=="country"){
						        		url =baseUrl + "platform/exportMonthlyByBDSC.action?beginDate="+beginDate+"&endDate="+endDate+str+"";
									...
									if(soType=="shop"){
						        		url =baseUrl + "platform/exportQuarterly.action?beginDate="+beginDate+"&endDate="+endDate+str+"";

									}else if(soType=="customer"){
						        		url =baseUrl + "platform/exportQuarterlyCustomer.action?beginDate="+beginDate+"&endDate="+endDate+str+"";

									}else if(soType=="country"){
						        		url =baseUrl + "platform/exportQYCByBDSC.action?beginDate="+beginDate+"&endDate="+endDate+str+"&YQC=quar";
									...
									if(soType=="shop"){
						        		url = baseUrl + "platform/exportAnnual.action?beginDate="+beginDate+"&endDate="+endDate+str+"";

									}else if(soType=="customer"){
						        		url = baseUrl + "platform/exportAnnualCustomer.action?beginDate="+beginDate+"&endDate="+endDate+str+"";

									}else if(soType=="country"){
						        		url =baseUrl + "platform/exportQYCByBDSC.action?beginDate="+beginDate+"&endDate="+endDate+str+"&YQC=year";
									...
									if(soType=="shop"){
						        		url = baseUrl + "platform/exportCustom.action?beginDate="+beginDate+"&endDate="+endDate+str+"";

									}else if(soType=="customer"){
						        		url = baseUrl + "platform/exportCustomCustomer.action?beginDate="+beginDate+"&endDate="+endDate+str+"";

									}else if(soType=="country"){
						        		url =baseUrl + "platform/exportQYCByBDSC.action?beginDate="+beginDate+"&endDate="+endDate+str+"&YQC=custom";
...
function exportTemplate(what){
	var url = baseUrl + "platform/exportTemplate.action?spec=1&what="+what;
	location.href = url;
}
