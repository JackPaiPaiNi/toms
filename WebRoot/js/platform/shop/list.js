...
$(function(){
	$("#shopListTable").datagrid({
	    ...
	    columns:[[
	        ...
	        {field:'provinceId',title:locale("district.provinceId"),width:100,hidden:true},
	        {field:'cityId',title:locale("district.cityId"),width:100,hidden:true},
	        {field:'countyId',title:locale("district.countyId"),width:100,hidden:true},
	        {field:'townId',title:locale("district.townId"),width:100,hidden:true},
	        {field:'shopId',title:locale("shop.list.th.id"),width:100,hidden:true},
	        {field:'shopName',title:locale("shop.list.th.name"),width:100},
	        {field:'partyId',title:locale("shop.list.th.partyId"),width:100,hidden:true},
	        {field:'partyName',title:locale("shop.list.th.partyName"),width:100},
	        {field:'customerId',title:locale("shop.list.th.customer"),width:100,hidden:true},
	        {field:'customerName',title:locale("shop.list.th.customer"),width:100},
	        {field:'level',title:locale("contact.level"),width:50,formatter:levelformatter},
	        {field:'createBy',title:locale("shop.list.th.creator"),width:100,hidden:true},
	        {field:'createDate',title:locale("shop.list.th.createdate"),width:100,hidden:true},
//	        {field:'enterDate',title:locale("shop.list.th.enterdate"),width:100},
	        {field:'enterDateStr',title:locale("shop.list.th.enterdate"),width:100},
	        ...
	        {field:'contactName',title:locale("contact.contactName"),width:100},
	        {field:'phone',title:locale("contact.phone"),width:100},
	        {field:'email',title:locale("contact.email"),width:100},
	        {field:'lng',title:locale("shop.list.th.lng"),width:100,hidden:true},
	        {field:'lat',title:locale("shop.list.th.lat"),width:100,hidden:true},
	        {field:'comments',title:locale("shop.list.th.comments"),width:100,hidden:true},
	        {field:'location',title:locale("contact.location"),width:100},
	        {field:'status',title:locale("contact.status"),width:100,formatter:statusFormatter},
	        {field:'op',title:locale("toolbar.edit"),width:130,formatter:Formatter_x}
	    ]],
	    toolbar:'#shoptb',
...
/*	var countryId = $("#countryId").combobox("getValue");
	$.ajax({
		type:"GET",
		url:baseUrl + "platform/loadCustomerListData.action?countryId="+countryId+"&page=1&rows=200&bt=select"
	}).then(function(data){
		$(".tcladdwin input[name='customer']").combobox({
			data:data.rows||[],
			textField:"shopCustomerName",
...
function loadPartyCombo(countryId){
	...
	/*alert(countryId);
	$.getJSON(baseUrl + "platform/loadPartyListData.action?countryId="+countryId
			, function(json) {
		alert(data.rows);
        $('#partyId').combobox({  
                             data :data.rows,//获取要显示的json数据  
                             valueField: 'partyId',  
                             textField: 'partyName',  
                            });  
               });  
*/
	...
	/*$("#partyId").combobox({
		url:baseUrl + "platform/loadPartyListData.action?countryId="+countryId,
		textField:"partyName",
		valueField:"partyId"
	});
	*/
...
//	var province = $("#tcl_province").combobox("getValue");
	...
	var levelNum=$("#tcl_level").combobox("getValue");
	$("#shopListTable").datagrid({
		queryParams:{searchParty:searchParty,countryId:country,searchCustomer:searchCustomer,searchShop:searchShop,
					searchUserName:searchUserName,levelNum:levelNum}
	});
}
...
function importShops(){
	showImportWin(locale("shop.import"),baseUrl + "platform/importShop.action");
}

function importShopPersonnel (){
	showImportWin(locale("toolbar.importShopMapping"),baseUrl + "platform/importShopPersonnel.action");
}
function updateShopName (){
	showImportWin(locale("shop.updateShopName"),baseUrl + "platform/updateShopName.action");
}
