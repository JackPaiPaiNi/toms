...
import cn.tcl.platform.excelCustomer.dao.IExcelCustomerDao;
import cn.tcl.platform.excelCustomer.service.IExcelCustomerService;
import cn.tcl.platform.excelCustomer.vo.ExcelCustomer;

@Service("excelCustomerService")
public class ExcelCustomerServiceImpl implements IExcelCustomerService {
	@Autowired
	private IExcelCustomerDao excelDao;
	...
	public List<HashMap<String, Object>> selectStockBymodel(String spec,
		...
		return excelDao.selectStockBymodel(spec, searchStr, conditions,beginDate,endDate,isHq);
	}
	...
	public List<HashMap<String, Object>> selectDisplayBymodel(String spec,
			String searchStr, String conditions,String beginDate,String endDate,boolean isHq) throws Exception {
		return excelDao.selectDisplayBymodel(spec, searchStr, conditions,beginDate,endDate,isHq);
	}
...
*/
	...
	public List<HashMap<String, Object>> selectStockByData(String spec,
			String searchStr, String conditions,String beginDate,String endDate,boolean isHq) throws Exception {
		return excelDao.selectStockByData(spec, searchStr, conditions,beginDate,endDate, isHq);
	}

	@Override
	public List<HashMap<String, Object>> selectDisplayByData(String spec,
			String searchStr, String conditions,String beginDate,String endDate,boolean isHq) throws Exception {
		return excelDao.selectDisplayByData(spec, searchStr, conditions,beginDate,endDate,isHq);
	}
	...
	public List<HashMap<String, Object>> selectCPUDisplayBYBRANCH(
			String searchStr, String conditions,String beginDate,String endDate,boolean isHq) throws Exception {
		return excelDao.selectCPUDisplayBYBRANCH(searchStr, conditions,beginDate,endDate,isHq);
	}

	@Override
	public List<HashMap<String, Object>> selectCPUInventoryBYBRANCH(
			String searchStr, String conditions,String beginDate,String endDate,boolean isHq) throws Exception {
		return excelDao.selectCPUInventoryBYBRANCH(searchStr, conditions,beginDate,endDate,isHq);
	}
	...
	public List<HashMap<String, Object>> selectCPUDisplayByTTL(
			String searchStr, String conditions,String beginDate,String endDate,boolean isHq) throws Exception {
		return excelDao.selectCPUDisplayByTTL(searchStr, conditions,beginDate,endDate,isHq);
	}

	@Override
	public List<HashMap<String, Object>> selectCPUInventoryByTTL(
			String searchStr, String conditions,String beginDate,String endDate,boolean isHq) throws Exception {
		return excelDao.selectCPUInventoryByTTL(searchStr, conditions,beginDate,endDate,isHq);
	}
	...
	public List<HashMap<String, Object>> selectCoreProductByStock(
			String countryId,boolean isHq) throws Exception {
		return excelDao.selectCoreProductByStock(countryId,isHq);
	}

	@Override
	public List<HashMap<String, Object>> selectCoreProductBySample(
			String countryId,boolean isHq) throws Exception {
		return excelDao.selectCoreProductBySample(countryId,isHq);
	}
	...
	@Override
	public List<ExcelCustomer> selectSaleDataBySumByAc(String beginDate,
			String endDate, String searchStr, String conditions, boolean isHq) {
	...
	public List<HashMap<String, Object>> selectStockBymodelByAc(String spec,
			String searchStr, String conditions, String beginDate, String endDate,boolean isHq) throws Exception {
		return excelDao.selectStockBymodelByAc(spec, searchStr, conditions, beginDate,endDate,isHq);
	}

	@Override
	public List<HashMap<String, Object>> selectDisplayBymodelByAc(String spec,
			String searchStr, String conditions,String beginDate, String endDate, boolean isHq) throws Exception {
		return excelDao.selectDisplayBymodelByAc(spec, searchStr, conditions,beginDate,endDate, isHq);
	}
	...
	public List<HashMap<String, Object>> selectStockByDataByAc(String spec,
			String searchStr, String conditions, String beginDate, String endDate,boolean isHq) throws Exception {
		return excelDao.selectStockByDataByAc(spec, searchStr, conditions,beginDate,endDate, isHq);
	}

	@Override
	public List<HashMap<String, Object>> selectDisplayByDataByAc(String spec,
			String searchStr, String conditions, String beginDate, String endDate,boolean isHq) throws Exception {
		return excelDao.selectDisplayByDataByAc(spec, searchStr, conditions, beginDate,endDate,isHq);
	}
