...
*/  
 ...
 public static String [] list(String [] a,String [] b) {
  ...
  public static void setColor(String value,Cell contentCell,CellStyle cellStyleRED ,CellStyle cellStyleGreen,CellStyle cellStyleYellow) {
	  if (value.toString()
				.contains("%")
